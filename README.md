<h1 align="center">Free Game Dev Resources<br> </h1>

This work is a strimed down version of those to repos:
* [GameDev-Resources](https://github.com/Kavex/GameDev-Resources)
* [magictools](https://github.com/ellisonleao/magictools)

it only contains tools and assets stores that can be use for free for commercial use

---------------

:triangular_flag_on_post: = Free for commercial use but paid for extended capabilities, <!-- TODO: change "extended capabilities" to something better -->
:free: = 100% Free,
:o2: = Open Source
...
- [Engines](#engines)
	...
	- [Audio Middlewares](#audio-middlewares)
- [Meta](#meta)
...
* [Liberated Pixel Cup assets](http://lpc.opengameart.org) - Free graphic assets of the Liberated Pixel Cup (LPC) held by the OpenGameArt forums :free:
...
* [StickyPNG](http://www.stickpng.com/) - Free transparent PNG images. :free:
* [Time Fantasy](http://finalbossblues.com/timefantasy/) - Lovely SNES-Looking RPG Assets
* [TextureHaven](https://texturehaven.com/) - Free textures with additional maps like displacement and bump maps. Also HDRIs. :free:
...
* [AdMob by Google](https://admob.google.com/home/) - Google's Ads and monetization service for mobile.
...
* [Agen](http://2dengine.com) - Cross-Platform framework for making 2D games with Lua, compatible iOS, Mac and Windows devices. :free:
...
* [amulet](http://www.amulet.xyz/) - A free Lua-based audio/visual toolkit suitable for small games and experimentation. It runs on Windows, Mac, Linux, HTML5 and iOS. :o2:
* [Astera](https://github.com/tek256/astera) - 2D C99 Cross Platform Game Library / Framework :o2:
* [bitsy](https://ledoux.itch.io/bitsy) - A little editor for little games or worlds. The goal is to make it easy to make games where you can walk around and talk to people and be somewhere. :o2:
...
* [engo](https://engoengine.github.io/) - Engo is an open-source 2D game engine written in Go. :o2:
* [Farseer](https://github.com/VelcroPhysics/VelcroPhysics) - a collision detection system with realistic physics responses. :o2:
* [Flame](https://github.com/flame-engine/flame) - a minimalist game engine for Flutter :o2:
...
* [FXGL](https://github.com/AlmasB/FXGL) - A JavaFX/Kotlin game engine for Win/Mac/Linux. :o2:
* [GameSalad](https://gamesalad.com/) - Game Creation Engine for Mac and Windows.
* [GDevelop](https://gdevelop-app.com/) - An open-source, cross-platform 2D game engine designed for everyone - it's extensible, fast and easy to learn. :o2:
...
* [Gorgon](https://www.tape-worm.net/) - A 2D rendering API for .NET, written in C#. :o2:
* [Gosu](https://www.libgosu.org/) - 2D game development library for Ruby and C++ :o2:
* [Grid](http://www.planimeter.org/grid-sdk/) - A multiplayer-first game engine for Lua. :o2:
* [HaxeFlixel](http://haxeflixel.com/) - Create cross-platform games easier and free.
* [Heaps](https://heaps.io/) - Cross platform graphics for high performance games. :o2:
...
* [Inform7](http://inform7.com/) - A design system for interactive fiction based on natural language. :free:
* [Ink](http://www.inklestudios.com/ink/) - Scripting language for writing interactive narrative. :o2:
...
* [KogGE](https://korge.soywiz.com) - Modern Multiplatform Game Engine for Kotlin. Write games for the JVM, JavaScript, Android and iOS in no time using Kotlin. :o2:
* [LibGDX](https://libgdx.com/) - Powerful (totally free) library for Java, code once and run the game on desktop, Android, Web, and iOS. :o2:
...
* [LITIengine](http://litiengine.com/) - 2D Java Game Engine. It provides all the infrastructure to create tile based 2D games with plain java :o2:
...
* [Loom SDK](http://loomsdk.com/) - 2D mobile app and game framework with live reload of code and assets, AS3/JS/C#-like scripting language, and powerful 2D rendering and UI framework. Open source with paid "Turbo" service. :o2:
...
* [macrosquad](https://github.com/not-fl3/macroquad) - The cross-platform game engine in Rust. :o2:
...
* [nCine](https://ncine.github.io/) - A cross-platform 2D game engine with an emphasis on performance, written in C++11 and optionally scriptable in Lua. :o2:
* [NodeBox](https://www.nodebox.net/) - a family of Python tools to create generative design.
* [nuklear](https://github.com/vurtun/nuklear) - A minimalistic immediate mode GUI toolkit written in ANSI C. :o2:
* [ÖbEngine](https://github.com/Sygmei/ObEngine) - 2D Game Engine with Lua Scripting made on top of SFML ! :o2:
* [openFrameworks](https://openframeworks.cc/) - An open source and free C++ toolkit for creative coding. :o2:
...
* [phina.js](http://phinajs.com/) - A JavaScript game library that makes it easy to create games and tools. :o2:
* [Pixel Vision 8](https://pixelvision8.github.io/PixelVision8Website/) - a framework designed to simulate your favorite 8-bit consoles. :triangular_flag_on_post:
...
* [Planck.js](http://piqnt.com/planck.js/) - 2D JavaScript physics engine for cross-platform HTML5 game development. :o2:
...
* [Babylon.js](https://www.babylonjs.com/) - Javascript 3D Library. :o2:
* [Bevy](https://bevyengine.org/) - A refreshingly simple data-driven game engine built in Rust :o2:
...
* [Blitz3D](https://github.com/blitz-research/blitz3d) 3D basic-like programming language for fast 3D desktop games. :o2:
...
* [Jitter](https://github.com/mattleibow/jitterphysics) - a fast and lightweight physics engine written in C#. :o2:
...
* [Magnum](http://magnum.graphics/) - a lightweight and modular 2D/3D graphics/game engine written in C++11 :o2:
...
* [raylib](https://www.raylib.com/) - a simple and easy-to-use library to enjoy videogames programming, hardware accelerated with OpenGL (1.1, 2.1, 3.3 or ES 2.0) :o2:
...
* [ursina](https://www.ursinaengine.org/) - A game engine powered by python and panda3d. :o2:
...
* [Canabalt iOS](https://github.com/ericjohnson/canabalt-ios) :o2:
...
* [NetHack](https://github.com/NetHack/NetHack) :o2:
* [OpenTTD](https://github.com/OpenTTD/OpenTTD) :o2:
...
* [VVVVVV](https://github.com/TerryCavanagh/VVVVVV) :free:
...
* [EnTT](https://github.com/skypjack/entt) - Gaming meets modern C++, a fast and reliable entity-component system (ECS) and much more :o2:
...
* [Codecks](https://www.codecks.io) - Project Management Tool inspired by Collectible Card Games :triangular_flag_on_post:
...
* [GB Studio](https://www.gbstudio.dev/) - A free and easy to use retro adventure game creator for your favourite handheld video game system. :o2:
* [Solarus](https://www.solarus-games.org/) - Cross-platform 2D Action/Adventure C++ game engine with Lua API and game editor. :o2:
* [TIC-80](https://tic.computer/) - TIC-80 is a fantasy computer for making, playing and sharing tiny games. :o2:
* [Vassal](http://www.vassalengine.org/) - Vassal is a game engine for building and playing online adaptations of board games and card games. Play live on the Internet or by email. Vassal runs on all platforms, and is free, open-source software. :o2:
* [Wolf RPG Editor English](https://widderune.wixsite.com/widderune/wolf-rpg-editor-english) - open source editor for RPG Maker style gamesl :o2:

### 3D Game Engines

* [Cocos Creator](http://cocos2d-x.org/docs/editors_and_tools/creator/index.html) - Cocos Creator, a free cross-platform game development editor supporting Cocos2d-js, helps developers build 2D and 3D game scenes, edit game UI and other game resources quickly and efficiency. :free:
* [CRYENGINE](https://github.com/CRYTEK-CRYENGINE/CRYENGINE) - A pay what you want next gen 3D game engine written in C++. :triangular_flag_on_post:
...
* [Wwise](https://www.audiokinetic.com/products/wwise/) - AAA Audio engine used for The Witcher 3 and Overwatch, free up to 500 sound files and $150k of budget :triangular_flag_on_post:
* [Fmod](https://www.fmod.com/) - AA Audio engine used for Forza Horizon 3 and Tomb Raider, free up to $200k per year :triangular_flag_on_post:
...
* [DragonBones](http://dragonbones.com) - The Open Source 2D skeleton animation solution for Flash :o2:
...
* [MilkyTracker](https://github.com/milkytracker/MilkyTracker) - open source tracker for Mac/Linux/Windows platforms. :o2:
...
* [Kraken.io](https://kraken.io/) - robust, ultra-fast image optimizer and compressor with best-in-class algorithms. :triangular_flag_on_post:
...
* [Boardgamizer](http://www.boardgamizer.com/) - Board Game Design Idea Generator. :free:
* [RPTools](http://www.rptools.net/) - a brand of open-source programs designed to enhance traditional pen-and-paper role playing games. :o2:
...
* [Universal LPC Sprite Sheet Character Generator](http://gaurav.munjal.us/Universal-LPC-Spritesheet-Character-Generator) - Sprite character generator based on the LPC (Liberated Pixel Cup) graphics :o2:
...
* [MakeHuman](http://www.makehumancommunity.org/) - free and open source software to create realistic 3d humans :o2:
...
* [GraphicsGale](http://www.humanbalance.net/gale/us/) - Animation graphic editor easy to use. :free:
...
* [Sprite Sheet Packer](https://github.com/nickgravelyn/SpriteSheetPacker/) - Combine multiple images into a single sprite sheet and generate a txt map of it. :o2:
* [TexturePacker](https://www.codeandweb.com/texturepacker) - Great spritesheet creation editor. :triangular_flag_on_post:
* [Tilesplit](https://github.com/AlexPoulsen/tilesplit) - CLI text-based tilesheet splitter and namer. Turn a spritesheet into many separate files with names you pick, or not if you don't care. Support templates and textures that are not all the same size. :o2:
...
* [DEM Net Elevation API](https://elevationapi.com) - Live 3D textured terrain generation from real data - export height/normal maps, glTF, OBJ, STL :o2:
* [DEM Net Elevation API C#](https://github.com/dem-net/DEM.Net) - Terrain generation from real data with textures, normal maps, glTF, OBJ, STL support :o2:
...
* [Mixer](https://quixel.com/mixer) - Easy to use material creation tool that can be linked to the Megascans library to access all the ressources (Megascans free only for Unreal Engine users) :free:
* [Live Normal](https://tenebrislab.github.io/livenormal/) - An Android and iOS app for generating seamless materials on the go. You take a photo, and Live Normal creates a tile-able texture and generates texture maps ready for a PBR engine of your choice. :free:
...
* [Aseprite](http://www.aseprite.org/) - animated sprite editor & pixel art tool. :triangular_flag_on_post:
...
* [LibreSprite](https://libresprite.github.io/) - LibreSprite is an open source fork of Aseprite. :o2:
* [Multipaint](http://multipaint.kameli.net) - A cross-platform (Win, Linux, Mac) image editor/painter which covers the color limitations of 8-bit machines (like C64, ZX Spectrum etc.) :free:
...
* [project one](http://p1.untergrund.net) - A picture converter and editor for the Commodore 64 covering different graphics mode of this computer. Windows only :free:
* [REXPaint](https://www.gridsagegames.com/rexpaint/) - a powerful and user-friendly ASCII art editor. :free:
* [rx](https://rx.cloudhead.io/) - a modern & minimalist pixel editor :o2:
* [Spritemate](http://www.spritemate.com) - Online Editor for Commodore 64 Sprites :free:
* [Tilemancer](https://led.itch.io/tilemancer) - A quick procedural tile creator designed for pixel-art games. :free:
* [Timanthes](http://csdb.dk/release/?id=75871) - A pixel art editor for the Commodore 64 computer running on Windows :free:
...
* [MagicaVoxel](https://ephtracy.github.io/) - free lightweight 8-bit voxel editor and interactive path tracing renderer :free:
* [Q-Block](http://kyucon.com/qblock/) :free:
* [Sproxel](http://sproxel.blogspot.com.br/) - 3d interface designed to let the user quickly create and edit voxel-based 3d models :free:
...
* [miloyip/game-programmer](https://github.com/miloyip/game-programmer) A Study Path for Game Programmer octocat :free:
